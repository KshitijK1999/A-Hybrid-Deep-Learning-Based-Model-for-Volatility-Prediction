...
data1 = pd.read_csv('Predictions/Tin/Tin_E-LSTM_test.csv')
data1.Volatility_Tin_5_test_LSTM = data1.Volatility_Tin_5_test_LSTM.shift(5)
data1.Volatility_Tin_11_test_LSTM = data1.Volatility_Tin_11_test_LSTM.shift(11)
data1.Volatility_Tin_22_test_LSTM = data1.Volatility_Tin_22_test_LSTM.shift(22)
data1.Volatility_Tin_5_test_real_LSTM = data1.Volatility_Tin_5_test_real_LSTM.shift(5)
data1.Volatility_Tin_11_test_real_LSTM = data1.Volatility_Tin_11_test_real_LSTM.shift(11)
data1.Volatility_Tin_22_test_real_LSTM = data1.Volatility_Tin_22_test_real_LSTM.shift(22)
data1 = data1.dropna()
data = data1['Volatility_Tin_5_test_real_LSTM']
data = pd.DataFrame(data)

i=1
for files in onlyfiles:
    x = 'Predictions/Tin/{fname}'.format(fname = files)
    data1 = pd.read_csv(x)
    data1.Volatility_Tin_5_test_LSTM = data1.Volatility_Tin_5_test_LSTM.shift(5)
    data1.Volatility_Tin_11_test_LSTM = data1.Volatility_Tin_11_test_LSTM.shift(11)
    data1.Volatility_Tin_22_test_LSTM = data1.Volatility_Tin_22_test_LSTM.shift(22)
    ...
    data1.Volatility_Tin_22_test_real_LSTM = data1.Volatility_Tin_22_test_real_LSTM.shift(22)
    data1 = data1.dropna()
    data[i] = data1['Volatility_Tin_5_test_LSTM']
    i=i+1
...
data['Volatility_Tin_5_test_real_LSTM'] =  data['Volatility_Tin_5_test_real_LSTM'].astype('float64')
...
actual = data['Volatility_Tin_5_test_real_LSTM'].to_numpy().reshape(-1,)
...
import numpy as np
import base64
def create_download_link(df2, title = "Download CSV file", filename = "Tin.csv"):
