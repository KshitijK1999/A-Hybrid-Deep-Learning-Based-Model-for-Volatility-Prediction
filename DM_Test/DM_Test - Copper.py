...
# References:
#
# Harvey, D., Leybourne, S., & Newbold, P. (1997). TesCopperg the equality of 
#   prediction mean squared errors. International Journal of forecasCopperg, 
#   13(2), 281-291.
#
...
def dm_test(actual_lst, pred1_lst, pred2_lst, h = 1, crit="MSE", power = 2):
    # RouCoppere for checking errors
    def error_check():
        rt = 0
        msg = ""
...
data['Volatility_Copper_5_test_real_LSTM'] =  data['Volatility_Copper_5_test_real_LSTM'].astype('float64')
...
actual = data['Volatility_Copper_5_test_real_LSTM'].to_numpy().reshape(-1,)
